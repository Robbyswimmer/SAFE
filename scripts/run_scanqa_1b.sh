#!/bin/bash
#SBATCH --job-name=scanqa_1b
#SBATCH --output=logs/scanqa_1b_%j.out
#SBATCH --error=logs/scanqa_1b_%j.err
...
# ScanQA Joint Training — InternVL 1B
set -euo pipefail
...
MODEL_CONFIG=${MODEL_CONFIG:-scanqa_internvl_1b}
DATA_ROOT=${DATA_ROOT:-$SAFE_ROOT/data}
OUTPUT_DIR=${OUTPUT_DIR:-$SAFE_ROOT/outputs/scanqa_1b}
...
WANDB_RUN_NAME=${WANDB_RUN_NAME:-scanqa_1b_${SLURM_JOB_ID:-local}}
WANDB_TAGS=${WANDB_TAGS:-scanqa,joint,internvl,1b,pointbert,scaling}
