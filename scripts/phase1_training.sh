...
EVAL_AUDIO_GATE_COMPARISON=1  # Enable gate=0 vs gate=1 comparison logging
...
echo "  Fusion Layers:    [4,8,12,16,20,24,28,32,36] - DENSE injection every 4 layers"
echo "  Audio Tokens:     32 (was 16) - more granular representation"
echo "  Projector Scale:  LayerNorm (was tanh*10.0) - clean embeddings"
...
echo "  Trainable params: ~850M (was 189M) - 9 fusion layers @ 64 rank"
