...
# HPCC-adapted composition experiment: Interleaved audio + vision training
...
WANDB_TAGS=${WANDB_TAGS:-composition,interleaved,hpcc}
...
# Optional sequential composition objective
...
# Optional additivity-positive objective
...
# Optional interaction-mixer objectives
...
# Optional gate-product additivity objective
...
# Optional initialization checkpoints
INIT_AUDIO_CKPT=${INIT_AUDIO_CKPT:-}
INIT_VISION_CKPT=${INIT_VISION_CKPT:-}

# Optional learned per-layer gating
...
echo "============================================"
echo "  Composition Interleaved (HPCC) — ${SLURM_JOB_ID:-local}"
echo "============================================"
