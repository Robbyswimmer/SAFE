...
# HPCC-adapted RKCA experiment: Input token concatenation (no mid-layer fusion)
...
WANDB_TAGS=${WANDB_TAGS:-rkca,composition,concat,interleaved,hpcc}
...
echo "============================================"
echo "  RKCA (HPCC) — ${SLURM_JOB_ID:-local}"
echo "============================================"
