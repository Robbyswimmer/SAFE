...
# HPCC-adapted RKCA Joint experiment: Concat audio on InternVL 8B with native vision
# always active. Every training batch includes both audio and images.
...
WANDB_TAGS=${WANDB_TAGS:-rkca,joint,composition,concat,internvl,hpcc}
...
echo "============================================"
echo "  RKCA Joint (HPCC) — ${SLURM_JOB_ID:-local}"
echo "============================================"
