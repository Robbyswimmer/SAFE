...
TRAIN_BS=${TRAIN_BS:-8}
VAL_BS=${VAL_BS:-16}
NUM_WORKERS=${NUM_WORKERS:-2}  # Reduced from 8 to avoid shared memory exhaustion (can increase to 4 if stable)
SEED=${SEED:-42}
...
MAX_AUDIO_EVAL_BATCHES=${MAX_AUDIO_EVAL_BATCHES:-0}
MAX_VL_EVAL_BATCHES=${MAX_VL_EVAL_BATCHES:-0}
MAX_AUDIO_EVAL_SAMPLES=${MAX_AUDIO_EVAL_SAMPLES:-0}  # Changed from 600 to 0 (disabled = full eval)
