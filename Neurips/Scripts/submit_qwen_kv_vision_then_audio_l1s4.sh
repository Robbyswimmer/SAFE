...
VISION_SCRIPT="${VISION_SCRIPT:-Neurips/Scripts/run_qwen_kv_vision_only_l1s4_music_avqa.sh}"
AUDIO_SCRIPT="${AUDIO_SCRIPT:-Neurips/Scripts/run_qwen_kv_audio_after_vision_l1s4_music_avqa.sh}"
VISION_OUT="${VISION_OUT:-$SAFE_ROOT/checkpoints/qwen_kv_vision_only_l1s4}"
