...
# RKCA + subspace avoidance experiment (BCC)
# Modality tokens (audio, vision) are prepended to the text embedding sequence.
# Audio and vision projectors trained independently (interleaved), with subspace
# avoidance regularization to push projectors into orthogonal subspaces.
...
WANDB_TAGS=${WANDB_TAGS:-rkca,subspace,composition,concat,interleaved}
...
echo "============================================"
echo "  RKCA + Subspace (BCC) — ${SLURM_JOB_ID:-local}"
echo "============================================"
