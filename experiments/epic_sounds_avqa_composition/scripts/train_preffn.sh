#!/bin/bash
#SBATCH --job-name=epic-avqa-preffn
#SBATCH --output=logs/epic_avqa_preffn_%j.out
#SBATCH --error=logs/epic_avqa_preffn_%j.err
...
OUTPUT_DIR=${OUTPUT_DIR:-checkpoints/epic_sounds_avqa/preffn}
